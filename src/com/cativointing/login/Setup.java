...
public class Setup extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel39Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {cancelButton, signButton});
        ...
        jPanel39Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {cancelButton, signButton});
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(typesPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
    ...
    private void jTree1ValueChanged(javax.swing.event.TreeSelectionEvent evt) {//GEN-FIRST:event_jTree1ValueChanged
        businessName = nameField.getText() != null ? nameField.getText() : "";
        ...
        if (!businessName.equals("") && selectedNode != null) {
            ...
            if (selectedValue != null) {
                ...
                System.out.println("Selected " + businessCategory + ":" + businessType);
        ...
        if (flagForClientCode && flag) {
            ...
            if (confirm == javax.swing.JOptionPane.YES_OPTION) {
                ...
                try {
                    ...
                    writer.write(code + ",");
                    writer.write(pass + ",");
                    writer.write(businessName + ",");
                    writer.write(businessCategory + ",");
                    writer.write(businessType + "\n");
                    
                    BusinessInformation tempB = null;

                    switch (businessCategory) {
                        case "Retail" -> tempB = new RetailData(code, businessName, businessCategory, businessType);
                        case "Food Service" -> tempB = new FoodData(code, businessName, businessCategory, businessType);
                        case "Service-Based" -> tempB = new ServiceData(code, businessName, businessCategory, businessType);
                        default -> System.out.println("ERROR: username's category does not exist");
                    }
                    
                    if (tempB != null) AvailableBusinesses.businesses.put(code, tempB);
