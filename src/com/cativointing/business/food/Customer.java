...
public class Customer extends javax.swing.JPanel {
    ...
    public Customer() {
        ...
        for (CustomerData c : FoodData.getCUSTOMERS().values()) {
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Customer Info", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 18))); // NOI18N
        ...
        private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
            ...
            FoodData.addCustomer(new CustomerData(id, name, contact, email));
        ...
        private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
            ...
            FoodData.getCustomer(id).setName(name);
            FoodData.getCustomer(id).setContact(contact);
            FoodData.getCustomer(id).setEmail(email);
