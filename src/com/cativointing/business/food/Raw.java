...
public class Raw extends javax.swing.JPanel {
    ...
    private javax.swing.GroupLayout rawLayout;
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Raw Material Info", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 18))); // NOI18N
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Raw Products", "Quantity", "Supplier"
            }
        ) {
    ...
    public void refresh() {
        ...
        private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
            ...
            if (supp <= 0) {
                javax.swing.JOptionPane.showMessageDialog(null, "ADD: Please enter a valid supplier ID");
                return;
            }

            if (FoodData.getSUPPLIERS().containsKey(supp) == false) {
                javax.swing.JOptionPane.showMessageDialog(null, "ADD: Supplier ID does not exist");
                return;
            }

            model.addRow(new Object[]{id, name, qty, supp});
            FoodData.addRaw(new raw(id, name, qty, supp));
        ...
        private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
            ...
            if (supp <= 0) {
                javax.swing.JOptionPane.showMessageDialog(null, "UPDATE: Please enter a valid supplier ID");
                return;
            }
            ...
            model.setValueAt(supp, row, 3);
            FoodData.getRaw(id).setName(name);
            FoodData.getRaw(id).setQuantity(qty);
            FoodData.getRaw(id).setSupplierID(supp);
