...
import com.cativointing.userdata.food.supplier;
...
public class Supplier extends javax.swing.JPanel {
    ...
    public Supplier() {
        ...
        for (supplier s : FoodData.getSUPPLIERS().values()) {
            model.addRow(new Object[]{s.getID(), s.getName(), s.getContact(), s.getEmail()});
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Supplier Info", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 18))); // NOI18N
            ...
            public void valueChanged(javax.swing.event.ListSelectionEvent e) {
                if (!e.getValueIsAdjusting()) {
                    ...
                    if (selectedRow != -1) {
                        ...
                        System.out.println("Selected: " + id + ", " + name + ", " + contact + ", " + email);
                    }
                }
            }
        });
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        FoodData.addSupplier(new supplier(id, name, contact, email));
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        ...
        FoodData.getSupplier(id).setName(name);
        FoodData.getSupplier(id).setContact(contact);
        FoodData.getSupplier(id).setEmail(email);
        ...
        for (raw r : FoodData.getRAWS().values()) {
            if (r.getSupplierID() == id) {
                javax.swing.JOptionPane.showMessageDialog(null,
                        "REMOVE: ABORTING! There are raw products associated with this supplier");
                return;
            }
        }
