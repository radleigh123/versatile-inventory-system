...
public class Product extends javax.swing.JPanel {
    ...
    public Product() {
        ...
        categCombo.addActionListener(new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                if (categCombo.getSelectedItem().toString().equals("Add Category")) {
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Product Info", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 18))); // NOI18N
        ...
        categCombo.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        categCombo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Add Category" }));
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(categCombo, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                                .addComponent(qtyField)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(qtyCombo, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        String categ = categCombo.getSelectedItem().toString() == "Add Category" ? "" : categCombo.getSelectedItem().toString();
        String qty = qtyField.getText().matches("^[0-9]+$") ? qtyField.getText() : "";
        String unit = qtyCombo.getSelectedItem().toString() == "Add Qty" ? "" : qtyCombo.getSelectedItem().toString();
        qty = qty + " " + unit;
        int supp = suppField.getText().matches("^[0-9]+$") ? Integer.parseInt(suppField.getText()) : 0;
        double price = priceField.getText().matches("^[0-9]+(\\.[0-9]+)?$") ? Double.parseDouble(priceField.getText()) : 0;
        ...
        if (categ.equals("")) {
            // if category is empty, show dialog to add new category
            int confirm = javax.swing.JOptionPane.showConfirmDialog(null,
                    "Empty category, do you want to add a new category?",
                    "Confirm", javax.swing.JOptionPane.YES_NO_OPTION);
        ...
        if (unit.equals("")) {
            javax.swing.JOptionPane.showMessageDialog(null, "ADD: Please select a unit");
            return;
        }
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        for (int i = 0; i < model.getRowCount(); i++) {
            if (searchedID == (int) model.getValueAt(i, 0)) {
                ...
                String completeQty = (String) model.getValueAt(i, 3);
                ...
                for (int j = 0; j < categCombo.getItemCount(); j++) {
                    if (categ.equals(categCombo.getItemAt(j))) {
                        categCombo.setSelectedIndex(j);
                        break;
                    }
                }
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        ...
        String qty = qtyField.getText().matches("^[0-9]+$") ? qtyField.getText() : "";
        String unit = qtyCombo.getSelectedItem().toString() == "Add Qty" ? "" : qtyCombo.getSelectedItem().toString();
        qty = qty + " " + qtyCombo.getSelectedItem().toString();
        int supp = suppField.getText().matches("^[0-9]+$") ? Integer.parseInt(suppField.getText()) : 0;
        ...
        if (categ.equals("")) {
            javax.swing.JOptionPane.showMessageDialog(null, "UPDATE: Please select a valid category");
            return;
        }
        ...
        if (unit.equals("")) {
            javax.swing.JOptionPane.showMessageDialog(null, "UPDATE: Please select a unit");
            return;
        }
        ...
        if (name.equals(model.getValueAt(row, 1))
                ...
                && qty.equals(model.getValueAt(row, 3))
    ...
    private void removeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeButtonActionPerformed
        ...
        if (unit.equals("")) {
            javax.swing.JOptionPane.showMessageDialog(null, "REMOVE: Please select a unit");
            return;
        }
    ...
    private void createCategory() {
        String newCateg = javax.swing.JOptionPane.showInputDialog(null, "Enter new category");
        if (newCateg != null && !newCateg.equals("")) {
            categCombo.insertItemAt(newCateg, categCombo.getItemCount() - 1);
            categCombo.setSelectedItem(newCateg);
        }
    }
