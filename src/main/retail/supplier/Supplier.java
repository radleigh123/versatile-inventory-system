...
public class Supplier extends javax.swing.JPanel {
    ...
    public Supplier() {
        ...
        for (supplier s : RetailData.getSuppliers().values()) {
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Supplier Info",
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
                                        .addComponent(conField, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        if (RetailData.deleteSuppliers.containsKey(id)) {
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        ...
        RetailData.getSupplier(id).setName(name);
        RetailData.getSupplier(id).setContact(contact);
        RetailData.getSupplier(id).setEmail(email);
    ...
    private void removeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeButtonActionPerformed
        ...
        for (product p : RetailData.products.values()) {
            if (p.getSupp() == id) {
                javax.swing.JOptionPane.showMessageDialog(null,
                        "REMOVE: ABORTING! There are products associated with this supplier");
                return;
            }
        }
        ...
        model.removeRow(row);
        RetailData.deleteSuppliers.put(id, RetailData.getSupplier(id));
        RetailData.removeSupplier(id);
